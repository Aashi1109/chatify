...
import { handleOnunloadTokenClear } from "@/utils/generalHelper";
            ...
            if (loginResult?.data) {
              ...
              if (!!token && !!userId) {
                ...
                if (!values.rememberMe) {
                  window.addEventListener("unload", handleOnunloadTokenClear);
                } else {
        ...
        {({ isSubmitting, errors, setValues, touched, resetForm }) => (
          <Form className="flex flex-col gap-6">
            ...
            <button
              ...
              className="w-full rounded-lg text-center px-4 py-[10px] bg-white text-black mb-4 font-semibold"
            >
